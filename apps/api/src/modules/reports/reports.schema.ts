...
export const REPORT_DEFINITION_DEFAULTS = Object.freeze([
  ...
  { code: 'subcontractor-contracts', name: 'Subcontractor Contracts', domain: 'SUBCONTRACTORS', requiredPermissions: ['reports.finance.read'] },
  { code: 'subcontractor-payments', name: 'Subcontractor Payments', domain: 'SUBCONTRACTORS', requiredPermissions: ['reports.finance.read'] },
  { code: 'subcontractor-ledger', name: 'Subcontractor Ledger', domain: 'SUBCONTRACTORS', requiredPermissions: ['reports.finance.read'] },
  { code: 'equipment-usage', name: 'Equipment Usage', domain: 'EQUIPMENT', requiredPermissions: ['reports.finance.read'] },
  ...
  { code: 'employee-payments', name: 'Employee Payments', domain: 'PEOPLE', requiredPermissions: ['reports.hr.read', 'reports.finance.read'] },
  ...
  { code: 'cash-accounts', name: 'Cash Account Register', domain: 'CASH', requiredPermissions: ['reports.finance.read'] },
  { code: 'bank-accounts', name: 'Bank Account Register', domain: 'BANK', requiredPermissions: ['reports.finance.read'] },
